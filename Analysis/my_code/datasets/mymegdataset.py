...
class MyMEGDataset(BaseDataset):
    """MEG Dataset for SSVEP data from my own experiments.
    ...
    _CHANNELS = ['FP1','AF7','AF3','F1','F3','F5','F7','FT7','FC5','FC3','FC1',
    ...
    _SUBJECTS = [SubInfo(ID='S{:d}'.format(sub_idx),name=sname) for sub_idx,sname in zip(range(1,len(_NAME)+1,1),_NAME)]
